...
import { TrendingUp, IndianRupee, Download, ArrowUpRight } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <button className="flex items-center gap-2 px-4 py-2.5 bg-amber-500 hover:bg-amber-600 font-semibold text-white text-xs rounded-xl transition-all shadow-lg shadow-amber-500/20">
          <IndianRupee className="w-4 h-4" /> Request Payout (₹18,45,000.00)
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6">
          ...
          <p className="text-3xl font-bold text-amber-400">₹18,45,000.00</p>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6">
          ...
          <p className="text-3xl font-bold text-white">₹1,42,89,000.00</p>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6">
          ...
          <p className="text-3xl font-bold text-emerald-400">₹1,24,44,000.00</p>
