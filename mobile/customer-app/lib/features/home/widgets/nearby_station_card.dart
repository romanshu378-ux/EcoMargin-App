    ...
    return Container(
      ...
      child: Column(
        children: [
                        ...
                        GestureDetector(
                          ...
                          child: Padding(
                            ...
                            child: Icon(
                              ...
                              color: station.isFavorite ? const Color(0xFFEF4444) : (isDark ? const Color(0xFF94A3B8) : const Color(0xFF64748B)),
                              size: 20,
                            ),
                          ),
                        ),
          ...
          Divider(color: isDark ? const Color(0xFF1E293B) : const Color(0xFFF1F5F9), height: 1),
          const SizedBox(height: 12),

          // Bottom Specs & View Details CTA
          Row(
            children: [
              // Left area: 3 specs evenly distributed
              Expanded(
                child: Row(
                  children: [
